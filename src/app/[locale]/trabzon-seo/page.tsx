...
import { trabzonSeoContent } from "@/content/tr/trabzon-pages";

export const dynamic = "force-dynamic";

export default async function TrabzonSeoPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      ...
      <TrabzonLandingSection
        content={trabzonSeoContent}
        locale={resolvedLocale}
        relatedServiceSlug={{ tr: "seo-icerik", en: "seo-content" }}
      />
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return buildManagedMetadata(locale, "trabzonSeo");
}
